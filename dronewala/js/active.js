(function () {
    ...
    var DronewalaWindow = $(window);

    // :: Preloader
    DronewalaWindow.on('load', function () {
    ...
    // :: Dropdown Menu
    $(".sidenav-nav").find("li.Dronewala-dropdown-menu").append("<div class='dropdown-trigger-btn'><i class='ti ti-chevron-down'></i></div>");
    ...
    // :: Tooltip 
    var tooltipDronewala = [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]'))
    var tooltipList = tooltipDronewala.map(function (tooltip) {
        return new bootstrap.Tooltip(tooltip);
    });

    // :: Toast 
    var toastDronewala = [].slice.call(document.querySelectorAll('.toast'));
    var toastList = toastDronewala.map(function (toast) {
